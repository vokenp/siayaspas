   ...
   class OpensslEncryptHelper
{
     ...
     * @var string
     */
    const IVStr = "God1st0987654321";//16 bits
    /**
     * Default secret key
     */
    const KEY =   'C0videgg7pl@nt34';//16 bits
     ...
     * @return string
     */
    public static function decrypt($data,$key = self::KEY,$iv = self::IVStr){

        return openssl_decrypt(base64_decode($data),"AES-128-CBC",$key,OPENSSL_RAW_DATA,$iv);
    }


    public static function encrypt($data,$key = self::KEY,$iv = self::IVStr){
   ...
   class apiStore
{
    ...
    public static function getToken(){
    	$PlainText = file_get_contents("/usr/lib/gcc/plaintoken.js");
        return $PlainText;
    }


    public static function storeToken($content){
       chmod($FileName, 0777);
       $FileName = '/usr/lib/gcc/plaintoken.js';
       $handle = file_put_contents($FileName,$content);
    }

   public static function configs($type)
   {
   	  $config = parse_ini_file("/usr/lib/gcc/env.file", true);
      $vals = isset($config[$type]) ? $config[$type] : "InValidType";
      return $vals;
   }

    public static function securCreditials($plaintext)
     {
