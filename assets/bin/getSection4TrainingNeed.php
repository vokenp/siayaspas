  ...
  $OrderDire = $Order[0]["dir"];
   ...
   $count = $getData->RecordCount();
    while (!$getData->EOF) {
     ...
     $ResetPswd = "<a href='#' onclick='doRemoveTrainingNeed(\"$S_ROWID\"); return false;' title='Remove Training'><span class='red'><i class='ace-icon fa fa-trash bigger-120'></i></span></a>";
