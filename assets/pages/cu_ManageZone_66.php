...
<div class="widget-box">
        ...
        <div class="widget-body">
           ...
           <div class="form-group col-sm-6">
						<label class="col-sm-4 control-label " for="ZoneCode"> Zone Code </label>
						<div class="col-sm-8">
							<input type="text" id="ZoneCode" name="ZoneCode" placeholder="Enter Zone Code" class="col-xs-12 col-sm-12" value="<?php echo $rst['ZoneCode'];?>"  required="true" />
						</div>
					</div>
			   </div>
         <div class="row">
           <div class="form-group col-sm-6">
             <label class="col-sm-4 control-label " for="ZoneName"> Zone Name </label>
             <div class="col-sm-8">
               <input type="text" id="ZoneName" name="ZoneName" placeholder="Enter Zone Name" class="col-xs-12 col-sm-12" value="<?php echo $rst['ZoneName'];?>"  required="true" />
             </div>
           </div>
         </div>
