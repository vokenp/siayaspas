...
<div class="widget-box">
        ...
        <div class="widget-body">
           <div class="widget-main">
              ...
              <label class="col-sm-4 control-label " for="MobileNetOperator"> Mobile Net Operator </label>
              <div class="col-sm-8">
              <select name="MobileNetOperator" id="MobileNetOperator" class="col-xs-10 col-sm-10"  required="true">
              <?php echo $rs->GetListItems($rst["MobileNetOperator"],"MNO",$op);?>
             </select>
              </div>
            </div>
			   </div>
         ...
         <div class="row">
           <div class="form-group col-sm-6">
             <label class="col-sm-4 control-label " for="MNO_Prefix"> MNO Prefix </label>
             <div class="col-sm-8">
               <input type="text" id="MNO_Prefix" name="MNO_Prefix" placeholder="Enter MNO Prefix" class="col-xs-11 col-sm-11" value="<?php echo $rst['MNO_Prefix'];?>"  required="true" />
             </div>
           </div>
         </div>
