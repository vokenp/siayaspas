...
// Save SMM
        ...
        $.post('assets/bin/ManageRecords.php', $("#frmNewAppraisal").serialize(), function(data) {

          if (data.length < 15)
      {
      $(".close").click();
      var frm = "#frmNewAppraisal";
      $(frm)[0].reset();
      $(frm).trigger("reset");
  ...
  <div id="CreateTarget" class="modal fade" >
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form name="frmNewAppraisal" id="frmNewAppraisal" class="form-horizontal" role="form">
          <div class="modal-body">

            <div id="colAlert"></div>
            <input type="hidden" name="_token" id="_token" value="<?php echo $token; ?>" class="token">
            <input type="hidden" name="ModCode" id="ModCode" value="<?php echo $mod;?>">
            <input type="hidden" name="AppraiseeUserID" id="AppraiseeUserID" value="<?php echo $user;?>">
            <input type="hidden" name="ReturnType" id="ReturnType" value="RstID">

      <div class="row">
        <div class="form-group col-sm-10">
         <label class="col-sm-4 control-label " for="PeriodID" > Select Period </label>
         <div class="col-sm-8">
           <select id="AppPeriodID" name="AppPeriodID" required="true"   class="col-xs-12 col-sm-12 chosen-select">
             <?php
