...
$modUrl = $rs->Modurl($ModuleCode);
 ...
 $AddLink = "<a href='#' data-toggle='modal' data-target='#modal-NewNotification' class='dt-button btn btn-white btn-primary btn-bold' title='Add New'><i class='fa fa-plus  fa-lg'></i> Add New</a>";
         ...
         "style": "multi"
          ...
          "ajax":{
           ...
           "data":function(data) {
            ...
            error: function(resp){  // error handling code
          ...
          <div class="modal-dialog modal-md">
            ...
            <div class="col-sm-8">
              <select name="NType" id="NType"  class="col-xs-10 col-sm-10" style="width:100%;" required="true">
                <?php echo $rs->GetListItems("","NotificationType","add");?>
              </select>
            </div>
          </div>
            ...
            <div class="col-sm-8">
              <select name="CommitteeID" id="CommitteeID"  class="col-xs-10 col-sm-10" style="width:100%;" required="true">
                <?php 
                  $where = " where 1=1 ";
            ...
            <div class="col-sm-8">
              <textarea name="NBody" id="NBody" rows="5" class="col-xs-10 col-sm-10" required="true"></textarea>
            </div>
          </div>
