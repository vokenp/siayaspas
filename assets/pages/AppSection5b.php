<?php
$getS5BVals = $db->GetArray("SELECT ValueType,SA_ScoreValue,SA_Remarks FROM tbl_section5b where AppraisalID='$cid'");
   ...
   S5BdoValuesum();
      ...
      $("#btnPostValues5B").click(function(){
        var postdata = $("#frmValueOptions5B").serializeArray();
         postdata.push({name: 'btnPostValues5BRates', value: $("#S_ROWID").val()});
