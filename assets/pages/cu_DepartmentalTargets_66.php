...
$rst = $rs->row($TableName,"S_ROWID='$cid'");
 ...
 $AppDeptID = $rst["DeptID"];
 $AppDeptInfo = $rs->row("vw_departments","S_ROWID='$AppDeptID'");

      $DirectorateName = $AppDeptInfo["DirectorateName"];
      $DepartmentName = $AppDeptInfo["DepartmentName"];
      $HeadedBy = $AppDeptInfo["HeadofDept"];
...
<script type="text/javascript">
 ...
 // do other stuff for a valid form
    ...
    $.post('assets/bin/ManageRecords.php', $("#frmNewObjectives").serialize(), function(data) {
     ...
     $(frm).find(":submit").html("<i class='fa fa-plus'></i> Create New Object");
...
<div class="widget-box">
       ...
       <div class="widget-body">
           ...
           <div class="row">
             ...
             <div class="profile-user-info profile-user-info-striped ">
              <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                  <span class="editable" id="username"><b><?php  echo $HeadedBy;?></b></span>
                </div>
              </div>
            </div>
                </div>
         ...
         <div class="widget-toolbox padding-8 clearfix ">
               ...
               <?php include("DepartmentalTargets.php");?>
         </div>
       </div><!-- End Widget-body -->
