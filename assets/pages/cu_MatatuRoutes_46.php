        ...
        <div class="widget-body">
           <div class="widget-main">
        	  ...
        	  <div class="row">
					...
					<label class="col-sm-4 control-label " for="RouteNumber"> Route Number </label>
						<div class="col-sm-8">
							<input type="text" id="RouteNumber" name="RouteNumber" placeholder="Enter Route Number" class="col-xs-12 col-sm-12" value="<?php echo $rst['RouteNumber'];?>"  required="true" />
						</div>
					</div>
			   ...
			   <div class="row">
                 	<div class="form-group col-sm-6">
					<label class="col-sm-4 control-label " for="Destinations"> Destinations </label>
						<div class="col-sm-8">
							<textarea id="Destinations" name="Destinations" placeholder="Enter Destinations" required="true" class="col-xs-12 col-sm-12" rows="5"><?php echo $rst['Destinations'];?></textarea>
						</div>
					</div>
			   </div>
			    ...
			    <div class="row">
                 	<div class="form-group col-sm-6">
					<label class="col-sm-4 control-label " for="Destinations"> CBD Stage </label>
						<div class="col-sm-8">
							<textarea id="CBDStage" name="CBDStage"  required="true" class="col-xs-12 col-sm-12" rows="5"><?php echo $rst['CBDStage'];?></textarea>
						</div>
					</div>
			   </div>
