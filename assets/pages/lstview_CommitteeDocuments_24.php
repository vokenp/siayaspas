<script type="text/javascript">
  $(document).ready(function(){
   ...
   else
   {
    ...
    var dataTable = $('#TblDocTypes').DataTable({
        ...
        previous: '<i class="fa fa-chevron-left">'  
         ...
         "ajax":{
            url :"assets/bin/getCommitteeTypes.php", // json datasource
   ...
   function OpenDocType(CategoryID)
   {
        var DocType = $("#CatID-"+CategoryID).data("value");
       $("#tDef").html("Document Panel : <b>"+DocType+"</b>");
       $("#Colh3").html("<b>Upload new: "+DocType+"</b>");
       $("#CurDocType").val(DocType);
        $("#CategoryID").val(CategoryID);
        $("#StoragePool").val("CommitteeDocs-"+CategoryID);
       $("#TblDocuments").DataTable().draw();
       $("#btnUpNew").show();
      // $("#tblToolBar").show();
   }
        ...
        <div class="modal-body">
         ...
         <div class="row">
          ...
          <div class="row">
           ...
           <div class="row">
            <div class="form-group">
            <label class="col-sm-3 control-label " for="CommitteeDocType"> Document Category </label>
            <div class="col-sm-9">
              <select id="CommitteeDocType" name="CommitteeDocType"  class="col-xs-10 col-sm-10"  required="true" >
                <?php echo $rs->GetListItems("","CommitteeDocType","add");?>
              </select>
            </div>
          </div>
          </div>
