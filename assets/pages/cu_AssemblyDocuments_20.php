           ...
           <div class="widget-main">
        	  ...
        	  <div class="row">
                 	<div class="form-group col-sm-5">
						<label class="col-sm-4 control-label " for="DocumentTitle"> DocumentTitle </label>
						<div class="col-sm-8">
							<input type="text" id="DocumentTitle" name="DocumentTitle" placeholder="Enter M" class="col-xs-11 col-sm-11" value="<?php echo $rst['DocumentTitle'];?>"  required="true" />
						</div>
					</div>
					<div class="form-group col-sm-5">
						<label class="col-sm-4 control-label " for="DocumentType"> DocumentType </label>
						<div class="col-sm-8">
							<input type="text" id="DocumentType" name="DocumentType" placeholder="Enter DocumentType" class="col-xs-11 col-sm-11" value="<?php echo $rst['DocumentType'];?>"  required="true" />
						</div>
					</div>
			   </div>
