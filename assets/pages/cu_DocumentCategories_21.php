...
$btn = "<button type='submit' name='btnUpdateRecord' id='btnUpdateRecord' class='btn btn-sm btn-success' value='$TableName'><i class='fa fa-edit'></i> Update Record</button>";
  ...
  $EnableEmpty = $rst["EnableEmpty"] == 'Y' ? "checked='true'" : "";
  ?>
<script type="text/javascript">
	$(document).ready(function(){
		var op = $("#op").val();
		 ...
		 $('#btnEnableEmpty').on('click', function(){
           ...
           <div class="widget-main">
        	  ...
        	  <div class="row">
                 	<div class="form-group col-sm-7">
						<label class="col-sm-4 control-label " for="DocumentCategory"> Document Category </label>
						<div class="col-sm-8">
							<input type="text" id="DocumentCategory" name="DocumentCategory" placeholder="Enter Document Category" class="col-xs-11 col-sm-11" value="<?php echo $rst['DocumentCategory'];?>"  required="true" />
						</div>
					</div>
			   ...
			   <div class="row">
                 	<div class="form-group col-sm-7">
						...
						<div class="col-sm-8">
							<input type="text" id="DisplayOrder" name="DisplayOrder" placeholder="Enter DisplayOrder" class="col-xs-11 col-sm-11 NumberOnly" value="<?php echo $rst['DisplayOrder'];?>"  required="true" />
						</div>
					</div>
			   ...
			   <div class="row">
			   	<div class="form-group col-sm-7">
						<label class="col-sm-6 control-label " for="DisplayButton">Enable Empty View </label>
						<div class="col-sm-5">
							<input  id="btnEnableEmpty" class="ace ace-switch ace-switch-5" type="checkbox" <?php echo $EnableEmpty; ?> />
							<span class="lbl"></span>
                          <input type="hidden" name="EnableEmpty" id="EnableEmpty" value="<?php echo $rst["EnableEmpty"];?>" >
						</div>
					</div>
			   </div>
