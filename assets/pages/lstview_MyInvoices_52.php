      ...
      function dotoken()
{
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 id="Colh3" class="smaller lighter blue no-margin">Create Invoice </h3>
        </div>
  ...
  <input type="hidden" name="ModCode" id="ModCode" value="<?php echo $mod;?>">
  <input type="hidden" name="VendorID" id="VendorID" value="<?php echo $user;?>">
  <input type="hidden" name="ReturnType" id="ReturnType" value="RstID">

            <div class="row">
            <div class="form-group">
            <label class="col-sm-3 control-label " for="InvoiceType"> Invoice Type </label>
            <div class="col-sm-9">
            <select name="InvoiceType" id="InvoiceType" class="col-xs-10 col-sm-10"  required="true">
            <?php echo $rs->GetListItems("","InvoiceType","add");?>
           </select>
            </div>
          </div>
         </div> 
         ...
         <div class="row">
             <div class="form-group">
            <label class="col-sm-3 control-label " for="InvoiceNo"> InvoiceNo </label>
            <div class="col-sm-9">
              <input type="text" id="InvoiceNo" name="InvoiceNo" placeholder="InvoiceNo" class="col-xs-10 col-sm-10" required="true" />
            </div>
          </div>
          </div>
          ...
          <div class="row">
            <div class="form-group">
            <label class="col-sm-3 control-label " for="InvoiceDate"> Invoice Date </label>
            <div class="col-sm-9">
              <input type="text" id="InvoiceDate" name="InvoiceDate" placeholder="Select Invoice Date" class="col-xs-10 col-sm-10"  required="true" />
            </div>
          </div>
          </div>
      <div class="row">
            <div class="form-group">
            <label class="col-sm-3 control-label " for="InvoiceAmount">  Invoice Amount </label>
            <div class="col-sm-9">
              <input type="text" id="InvoiceAmount" name="InvoiceAmount" placeholder="Enter Invoice Amount" class="col-xs-10 col-sm-10"  required="true" />
            </div>
          </div>
          </div>
         ...
         <div class="row">
            <div class="form-group">
            <label class="col-sm-3 control-label " for="InvoiceDescription"> Description</label>
            <div class="col-sm-9">
              <input type="text" id="InvoiceDescription" name="InvoiceDescription" placeholder="Enter Invoice Description" class="col-xs-10 col-sm-10"  required="true" />
            </div>
          </div>
          </div>
