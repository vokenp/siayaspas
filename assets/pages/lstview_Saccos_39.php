...
$modUrl = $rs->Modurl($ModuleCode);
 ...
 $AddLink = "<a data-toggle='modal' href='#CreateSacco' class='dt-button btn btn-white btn-primary btn-bold' title='Add New'><i class='fa fa-plus  fa-lg'></i> Add New</a>";
...
// do other stuff for a valid form
   $.post('assets/bin/ManageRecords.php', $("#frmsacco").serialize(), function(data) {
    ...
    $(frm).find(":submit").html("<i class='fa fa-send'></i> Save Route"); 
...
<div id="CreateSacco" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h3 id="Colh3" class="smaller lighter blue no-margin">Create New Sacco </h3>
        </div>
        <form name="frmsacco" id="frmsacco" class="form-horizontal" role="form">
    <div class="modal-body">
     <input type="hidden" name="_token" id="_token" class="token" value="<?php echo $token;?>">
      ...
      <div class="form-group">
          <label class="col-sm-3 control-label " for="SaccoName"> Sacco Name </label>
           <div class="col-sm-9">
             <input type="text" name="SaccoName" required="true" id="SaccoName" class="form-control" >
          </div>
        </div>     


      <div class="form-group">
          <label class="col-sm-3 control-label " for="SaccoRoute"> Sacco Route </label>
           <div class="col-sm-9">
             <input type="text" name="SaccoRoute" required="true" id="SaccoRoute" class="form-control" >
          </div>
        </div>

      <div class="form-group">
          <label class="col-sm-3 control-label " for="SaccoEmail"> Sacco Email </label>
           <div class="col-sm-9">
             <input type="text" name="SaccoEmail" required="true" id="SaccoEmail" class="form-control" >
          </div>
        </div>  

      <div class="form-group">
          <label class="col-sm-3 control-label " for="SaccoPhone"> Sacco Phone</label>
           <div class="col-sm-9">
             <input type="text" name="SaccoPhone" required="true" id="SaccoPhone" class="form-control" >
          </div>
        </div> 

        <div class="form-group">
          <label class="col-sm-3 control-label " for="PhysicalAddress"> Physical Address</label>
           <div class="col-sm-9">
             <input type="text" name="PhysicalAddress" required="true" id="PhysicalAddress" class="form-control" >
          </div>
        </div> 
